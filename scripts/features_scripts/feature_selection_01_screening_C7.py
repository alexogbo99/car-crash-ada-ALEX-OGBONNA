...
#
# Lightweight feature screening for C7 (crashes, sum 7-day horizon).
...
# - Saves results to results_feature_screening_C7.csv
...
TARGET_REG = "y_7d_sum"  # crashes tomorrow (C7)
# Classification target will be Z_crash_1d = 1{y_7d_sum > 0}
...
FEATURES_HISTORY = [
    "y_lag1",
    "y_roll7",
    # If you later add more lags/rolls, put them here.
]
...
FEATURES_STATIC_TRAFFIC = [
    ...
    # we will EXCLUDE neighbor_local_severity_uncertainty & delta_local_severity_uncertainty_vs_neighbors later
]
...
FEATURES_ROAD = [
    ...
    # if you later add neighbor road deltas, put them here
]
...
FEATURES_OTHER = [
    ...
    "n_persons_injured",
    "n_persons_killed",
    # neighbor_local_severity_uncertainty and delta_local_severity_uncertainty_vs_neighbors are all zero -> skip
]
...
def build_report(candidate_features,
    ...
    # Optional: sort a bit for readability
...
def main():
    print("=== Feature Screening for C7 (y_7d_sum) ===")
    print(f"ROOT:           {ROOT}")
