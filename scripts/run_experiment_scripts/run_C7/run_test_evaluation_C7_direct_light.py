...
# --- CRITICAL ARCHITECTURE INFERENCE (KEPT) ---
...
# ==============================================================================
# 2. MAIN EXECUTION (UPDATED WITH LOOP)
# ==============================================================================
def main():
    print("=== FINAL TEST EVALUATION (C7 | Direct | Light | DUAL METRIC) ===")
    with joblib.parallel_backend('threading', n_jobs=-1):
        
        # Load Validation Results
        results_file = RESULTS_DIR / "train_val_results_C7_Direct.json"
