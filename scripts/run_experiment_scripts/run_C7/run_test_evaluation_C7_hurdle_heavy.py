...
# ==============================================================================
def main():
    print("=== FINAL TEST EVALUATION (C7 | Hurdle | Heavy | DUAL METRIC) ===")
    with joblib.parallel_backend('threading', n_jobs=-1):
        
        # Load Validation Results
        results_file = RESULTS_DIR / "train_val_results_C7_Hurdle_heavy.json"
            ...
            for target in TARGETS:
                ...
                for tier in TIER_LIST:
                    try:
                        ...
                        # 2. Load Gatekeeper (Fixed Champion)
