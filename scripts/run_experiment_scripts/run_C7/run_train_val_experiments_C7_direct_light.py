# scripts/run_experiment_scripts/run_C7/run_train_val_experiments_C7_direct_light.py
...
RESULTS_DIR = ROOT / "results" / "C7_Direct_Light"
...
def write_run_manifest(results_dir: Path, payload: dict):
    path = results_dir / "run_manifest.json"
    payload = dict(payload)
    payload["written_at_utc"] = datetime.utcnow().isoformat()
    with open(path, "w") as f:
        json.dump(payload, f, indent=2)

def main():
    print("=== TRAIN/VAL EXPERIMENTS (Direct | Light Mode | C7) ===")
    ...
    # ---- Run manifest ----
    write_run_manifest(RESULTS_DIR, {
        "target_family": "C7",
        "method": "Direct",
        "mode": "Light",
        "targets": TARGETS,
        "tiers": TIER_LIST,
        "history_variants": HISTORY_LIST,
        "algorithms": ALGOS,
                ...
                for algo in ALGOS:
                    ...
                    try:
                        ...
                        model, tuning_info = get_optimized_model(
                            ...
                            light_mode=True, return_cv_results=True
                        )
                        ...
                        rpath = RESULTS_DIR / "train_val_results_C7_Direct.json"
