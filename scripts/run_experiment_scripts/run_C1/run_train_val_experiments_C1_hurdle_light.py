# scripts/run_experiment_scripts/run_C1/run_train_val_experiments_C1_hurdle_light.py
...
def main():
    print("=== TRAIN/VAL EXPERIMENTS C1 (Hurdle | Light | Windows Safe) ===")
                        ...
                        try:
                            ...
                            if algo in ["MLP", "GRU"]:
                                regressor = get_optimized_model(
                                    ...
                                    X_train=X_train_in, y_train=y_train, light_mode=True, return_cv_results=False
                                )
                            ...
                            res = {
                                ...
                                "history": hist_var, **metrics, "time_sec": dt, "requires_scaling": needs_scaling
                            }
                            save_to_csv(res, METRICS_CSV)
                            
                            rpath = RESULTS_DIR / "train_val_results_C1_Hurdle_light.json"
