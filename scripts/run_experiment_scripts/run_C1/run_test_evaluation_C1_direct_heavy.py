...
def load_or_fit_train_scaler(
    ...
    *,
    ...
    try:
        ...
        print(f"⚠️  Streaming scaler fit failed ({e}). Falling back to full read.")
...
# ==============================================================================
def main():
    print("=== FINAL TEST EVALUATION (C1 | Direct | Heavy | DUAL METRIC) ===")
                ...
                for tier in TIER_LIST:
                    try:
                        ...
                        if best_algo in ["MLP", "GRU"]:
                            ...
                            # Use robust inference instead of config dictionary
                            if best_algo == "MLP":
