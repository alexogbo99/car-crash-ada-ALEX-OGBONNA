...
RESULTS_DIR = ROOT / "results" / "C1_Hurdle_Heavy"
...
def main():
    print("=== FINAL TEST EVALUATION (C1 | Hurdle | Heavy | DUAL METRIC) ===")
    with joblib.parallel_backend('threading', n_jobs=-1):
        
        results_file = RESULTS_DIR / "train_val_results_C1_Hurdle_heavy.json"
