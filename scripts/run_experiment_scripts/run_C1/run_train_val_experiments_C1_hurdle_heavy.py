# scripts/run_experiment_scripts/run_C1/run_train_val_experiments_C1_hurdle_heavy.py
...
def main():
    print("=== TRAIN/VAL EXPERIMENTS C1 (Hurdle | No Wrapper | Windows Safe) ===")
                ...
                for hist_var in HISTORY_LIST:
                    ...
                    for algo in ALGOS:
                        ...
                        try:
                            ...
                            rpath = RESULTS_DIR / "train_val_results_C1_Hurdle_heavy.json"
