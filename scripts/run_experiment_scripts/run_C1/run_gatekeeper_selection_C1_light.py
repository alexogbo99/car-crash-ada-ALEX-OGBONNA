# scripts/run_experiment_scripts/run_C1/run_gatekeeper_selection_C1_light.py
...
def main():
    print("=== GATEKEEPER SELECTION (All Tiers | Light Mode | Pipeline Fixed) ===")
